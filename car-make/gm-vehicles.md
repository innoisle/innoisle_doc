...
\*We have discontinued 2x13 pin harness box. You will receive 2x9 pin versions for GM harness sets.
...
3. If you plan to purchase the harness + box (GM only) from me, then it is 2x9 pin box
...
5. If you purchased a customized harness for Tesla from other seller, you will need a 2x13 pin box, but it usually comes with a 2x13 pin harness box.&#x20;
