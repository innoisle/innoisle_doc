...
# Side Slidemount (C4) Installation Guide

\*Disclaimer: This is a guide only.

**This installation guide applies to the Side Slidemount for C4**<br>

## **Set Screw Warning:**

**\*Over-tightening the set screw could break your Comma Device/ Slidemount Brackets**

**Set screw is required for Slidemount**: \
\- Set screw is NOT Pre-Installed for Side Slidemount\
...
\- Over-tightening it will cause the **breakage of the mounting bracket or your device bracket**.&#x20;

This is an example of 4 set screws installed for the C4 Side Slidemount Device side

<div align="left"><figure><img src="../.gitbook/assets/set screw for C4 slidemount-2.png" alt=""><figcaption></figcaption></figure></div>

This is an example of installiong 2 set screws for the C3 Device-Side Mount (Compatible with C4 Base)&#x20;

<div align="left"><figure><img src="../.gitbook/assets/set screw for C4 slidemount c3 device-2.png" alt="" width="301"><figcaption></figcaption></figure></div>
...
{% content-ref url="slidemount-c4.md" %}
[slidemount-c4.md](slidemount-c4.md)
{% endcontent-ref %}

### Please find the video installation guide after the VHB preparation

### (Optional) Prepare your VHB: (ONLY if you redo the VHB)

1. All slidemount already come with **pre-applied VHB**. \
...
2. Warning: Apply the VHB tape to the slidemount, first before you stick it on the windshield. And apply the VHB in warm temp.\
...
{% embed url="https://youtu.be/cuIYjNaCf5E" %}

### Slidemount C4 Device Slidemount with C3 bracket Installation Guide
